  ...
  var larg = lpicto*36; // largeur du tracé
  var haut =440; // hauteur de tracé
  var barPadding =lpicto;// espace entre les barres
  var lb =(lpicto*5);//Largeur d'une barre
  var valeurMax = 100; // valeur mawimale d'une barre
  ...
  function draw (dataset){
      ...
      creationMotif(svg,"data/graph3/nuc.svg","nucleaire_clair");
      creationMotif(svg,"data/graph3/geo.svg","geothermique_clair");
      creationMotif(svg,"data/graph3/bio.svg","biomasse_clair");
      creationMotif(svg,"data/graph3/sol.svg","solaire_clair");
      creationMotif(svg,"data/graph3/eolien.svg","eolien_clair");
      creationMotif(svg,"data/graph3/hyd.svg","hydrolique_clair");
  
      creationMotif(svg,"data/graph3/nucp.svg","nucleaire_sombre");
      creationMotif(svg,"data/graph3/geop.svg","geothermique_sombre");
      creationMotif(svg,"data/graph3/biop.svg","biomasse_sombre");
      creationMotif(svg,"data/graph3/solp.svg","solaire_sombre");
      creationMotif(svg,"data/graph3/eolienp.svg","eolien_sombre");
      creationMotif(svg,"data/graph3/hydp.svg","hydrolique_sombre");
  ...
  function nomEnergie(dataset){
    ...
    svg.selectAll("text.energie")
      ...
      .attr("class", "energie")
      .text(function(d){
              if ((d.energie ==="Eolien") ||  (d.energie ==="Solaire"))
              {
                str = d.energie;
      ...
      .append("svg:line")
        .attr("x1", function(d, i){
            return((i * ((lpicto*4)-lpicto)/2));
       })
        .attr("y1", hauteur_legende-15)
        .attr("x2", function(d, i){
            return((i * ((lpicto*4)-lpicto)/2)+lpicto);
       })
        .attr("y2", hauteur_legende-15);
  }